  ...
  function ListItem({ product }) {
    return (
      <div className="list-item">
        ...
        {product.images.length ? product.images.map(image => <Image key={image.id} image={image.url} />)
          : noImages.map(image => <Image key={image.key} image="http://www.embaleme.com.br/img/noimage.jpg" />)}
